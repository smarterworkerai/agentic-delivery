...
WORKFLOW_DEFINITIONS: tuple[WorkflowDefinition, ...] = (
    ...
    WorkflowDefinition("do-impl", "adw-do-impl", "do-impl", "Implement and validate the approved plan; push/PR creation requires exact route approval."),
    WorkflowDefinition("do-impl-delegate", "adw-do-impl-delegate", "do-impl-delegate", "Delegate implementation through the portable handoff/result contract, then inspect the approved PR or returned patch."),
    ...
    WorkflowDefinition("merge-feature", "adw-merge-feature", "merge-feature", "Merge a validated PR into an approved destination and deploy only when separately requested and gated."),
    WorkflowDefinition("rollback-deployment", "adw-rollback-deployment", "rollback-deployment", "Restore a failed deployment with the approved adapter-declared strategy and report impact/follow-up."),
