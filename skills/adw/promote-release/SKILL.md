...
metadata:
  hermes:
    ...
    related_skills: [adw-core, adw-test-feature, adw-merge-feature]
---
...
6. Verify target environment using `adw-core/references/playbooks/deployment_gates.md`.
7. Report promotion result using `adw-core/templates/deployment_report.md`.
